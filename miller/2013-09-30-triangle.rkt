...
(define WAITING (star 8 "solid" "blue"))
...
(define-struct world (figure x y deltax deltay))
;; A world is (make-world figure Number Number Number)
...
;; Assignment:
;; (1) Complete the following wish list.
;; (2) When complete, make the star you get at the vertex "grow" as the
;;     animation waits.  Just before it moves it should be at size BIGGEST
;;     which you should define to be 8 in the constants section.

;;;;;;;;;;;;;; Wish List

;; world-waiting?: world -> boolean
;; GIVEN: a world
;; RETURNS: true iff the animation is waiting to draw a vertex
;; Examples omitted
;; Strategy: ???
(define (world-waiting? world)
  true)					; Fix
